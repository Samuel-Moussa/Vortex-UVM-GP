...
class host_driver extends uvm_driver #(host_transaction);
    ...
    virtual task reset_phase(uvm_phase phase);
        ...
        @(mem_vif.master_cb);
        mem_vif.master_cb.req_valid <= 1'b0;
        mem_vif.master_cb.req_rw <= 1'b0;
        mem_vif.master_cb.req_addr <= '0;
        mem_vif.master_cb.req_data <= '0;
        mem_vif.master_cb.req_byteen <= '0;
        mem_vif.master_cb.req_tag <= '0;
        mem_vif.master_cb.rsp_ready <= 1'b1;
    ...
    virtual task write_memory_word(
        ...
        @(mem_vif.master_cb);
        mem_vif.master_cb.req_valid  <= 1'b1;
        mem_vif.master_cb.req_rw     <= 1'b1;  // Write
        mem_vif.master_cb.req_addr   <= addr;
        mem_vif.master_cb.req_data   <= data;
        mem_vif.master_cb.req_byteen <= byteen;
        mem_vif.master_cb.req_tag    <= 0;
        
        // Wait for handshake
        do begin
            @(mem_vif.master_cb);
        end while (!mem_vif.master_cb.req_ready);
        ...
        do begin
            @(mem_vif.master_cb);
        end while (!mem_vif.master_cb.rsp_valid);
    endtask
    ...
    virtual task read_memory_word(
        ...
        @(mem_vif.master_cb);
        mem_vif.master_cb.req_valid  <= 1'b1;
        mem_vif.master_cb.req_rw     <= 1'b0;  // Read
        mem_vif.master_cb.req_addr   <= addr;
        mem_vif.master_cb.req_byteen <= 4'hF;
        mem_vif.master_cb.req_tag    <= 0;
        ...
        data = mem_vif.master_cb.rsp_data;
    endtask
